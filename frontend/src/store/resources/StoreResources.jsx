...
import{ResourceActionPanel,ResourceGridSection,ResourceModals,ResourceSignalBar}from'../../features/resources/components/index.jsx';
import{useResourceBatchActions,useResourceCategories,useResourceDetail,useResourcePagination,useResourceRename,useResourceSelection,useResourceUpload}from'../../features/resources/hooks/index.js';
import{deleteResource,fetchAdminResources,fetchPublicResources,updateResource}from'../../features/resources/api/index.js';
import{buildResourceCategoryGroups,buildResourceCategorySections,getResourceCategoryPurposeOptions,getResourceMainOptions,getResourceSubOptions}from'../../features/resources/model/index.js';
...
import{fixedCategoryUseLabel,normalizeResourceMain,normalizeResourceSub}from'./resourceModel.js';
...
function StoreResources({me,setMsg}){
  ...
  function loadSystemResources(){
    ...
    return loader({pageSize:20}).then(d=>setSys((d.items||[]).filter(x=>x.scope==='SYSTEM')));
  }
  ...
  useEffect(()=>{
    loadSystemResources().catch(e=>setMsg(e.message));
  },[isSystemAdmin]);
