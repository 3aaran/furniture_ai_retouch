...
import{Brush,Camera,Droplet,Eye,Image as ImageIcon,Layers,PenLine,Rotate3d,Search,WandSparkles}from'lucide-react';
import{resTypeName}from'../../appShared.jsx';
import WorkbenchUploadPanel from'./WorkbenchUploadPanel.jsx';
import{promotionFeatures,promotionOptionChoices,promotionOptionDefaults}from'./promotionFeatures.js';
import{AuroraLayer}from'../../shared/effects/index.jsx';
import{WorkbenchCanvasToolbar,WorkbenchFeaturePanel,WorkbenchFeaturePopover,WorkbenchLeftPanel,WorkbenchModals,WorkbenchRecentPanel,WorkbenchRecentSourcePreview,WorkbenchSignalBar,WorkbenchStudioControlPanel,WorkbenchStudioRecentStrip,WorkbenchVideoPanel,WorkbenchWatermarkOverlay}from'../../features/workbench/components/index.jsx';
import{buildWorkbenchOps,workbenchImageSrc,workbenchListImageSrc}from'../../features/workbench/model/index.js';
import{useVideoStoryboard,useWorkbenchFeatureMode,useWorkbenchGeneration,useWorkbenchImageUpload,useWorkbenchRecent,useWorkbenchResourceLibrary,useWorkbenchResourceUpload,useWorkbenchWatermark}from'../../features/workbench/hooks/index.js';
import{fetchPublicSettings}from'../../features/workbench/api/index.js';
