...
const paths: Record<AppIconName, string> = {
  ...
  dashboard: 'M4.75 4.75h6.5v6.5h-6.5v-6.5Zm8 0h6.5v4.5h-6.5v-4.5Zm0 6h6.5v8.5h-6.5v-8.5Zm-8 2h6.5v6.5h-6.5v-6.5Z',
  document: 'M6.25 3.75h7.5l4 4v12.5H6.25V3.75Zm7.5 0v4h4M9 12h6M9 15.5h6',
  model: 'M12 3.75 19 7.5v9L12 20.25 5 16.5v-9L12 3.75Zm0 0v7.75m7-4-7 4-7-4m7 4v8.75',
  settings: 'M12 8.75a3.25 3.25 0 1 0 0 6.5 3.25 3.25 0 0 0 0-6.5Zm0-5 .85 2.05 2.2.45 1.55-1.1 2.25 2.25-1.1 1.55.45 2.2 2.05.85v3.2l-2.05.85-.45 2.2 1.1 1.55-2.25 2.25-1.55-1.1-2.2.45-.85 2.05h-3.2l-.85-2.05-2.2-.45-1.55 1.1-2.25-2.25 1.1-1.55-.45-2.2-2.05-.85v-3.2l2.05-.85.45-2.2-1.1-1.55L5.15 5.2 6.7 6.3l2.2-.45.85-2.05H12Z',
  building: 'M5.25 20.25V5.75l6.75-2v16.5M12 8.25h6.75v12M7.75 8h1M7.75 11h1M7.75 14h1M15 11h1M15 14h1M15 17h1M3.75 20.25h16.5',
  workflow: 'M6.75 5.25h4.5v4.5h-4.5v-4.5Zm6 9h4.5v4.5h-4.5v-4.5ZM9 9.75v2.25a2.25 2.25 0 0 0 2.25 2.25h1.5M11.25 7.5h3a2.25 2.25 0 0 1 2.25 2.25v4.5',
  check: 'm5.75 12.25 4 4 8.5-8.5',
