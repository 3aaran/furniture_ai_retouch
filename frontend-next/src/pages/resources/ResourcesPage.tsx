...
type CategoryDialog =
  | null
  | { type: 'create-main' }
  | { type: 'create-sub'; mainId?: string | number }
...
export function ResourcesPage() {
  ...
  function openCreateSubDialog(main?: CategoryOption) {
    ...
    setNewSubName('');
    setNotice('');
    setCategoryDialog({ type: 'create-sub', mainId: main?.id });
  }
